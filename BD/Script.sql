...
insert into bodegas(codigo_bodega, nombre_bodega, estatus_bodega) values ('02','Anexo','1');
insert into marcas(codigo_marca, nombre_marca, estatus_marca) values ('02','adidas','1');
insert into lineas(codigo_linea, nombre_linea, estatus_linea) values ('02','sport','1');
insert into productos(codigo_producto, nombre_producto, codigo_linea, codigo_marca, existencia_producto, estatus_producto ) values ('02','toalla','02','02','202','1');
insert into existencias(codigo_bodega, codigo_producto, saldo_existencia) values ('01','02','3000');
